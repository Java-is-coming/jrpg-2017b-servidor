...
public class Servidor extends Thread {
    ...
    private static Map<Integer, PaqueteNPC> npcsARespawnear = new HashMap<>();

    private static Thread server;
    private static ServerSocket serverSocket;
    // private static Conector conexionDB;
    private static ConectorHibernate conexionDB;
    ...
    private static AtencionNPCs atencionNPCs;
    ...
    public void run() {
        try {
            ...
            conexionDB = new ConectorHibernate();
            conexionDB.connect();
     ...
     */
    public static boolean mensajeAAll(final PaqueteMensaje pqm, final int contador) {
        final int personajesConectadosQty = personajesConectados.size();
    ...
    /**
     * Getter de npcs a respaunear
     *
     * @return Map<Integer, PaqueteNPC>
     */
    public static Map<Integer, PaqueteNPC> getNpcsARespawnear() {
        return npcsARespawnear;
    }
     ...
     * @return Conector
     */
    public static ConectorHibernate getConector() {
        return conexionDB;
    }
